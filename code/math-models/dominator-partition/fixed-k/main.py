...
# display_results(m, x, d, V, E, PI, SEARCH_FEASIBLE, save_path=f"solutions/{GRAPH_NAME}/k={K}/seed={SEED}.txt", partitioning=True)
...
if is_feasible and not is_integral:
    ...
    display_results(m, x, d, V, E, PI, SEARCH_FEASIBLE, save_path=f"solutions/{GRAPH_NAME}/k={K}/seed={SEED}.txt")
