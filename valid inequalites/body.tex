...
\paragraph{Explanation} This potential inequality leverages the relationship between the average block size and the degree of a vertex $u$. The logic is as follows:
\begin{itemize}
